...
class ShoppingPageChidlrensMobile extends StatefulWidget {
  const ShoppingPageChidlrensMobile({Key? key}) : super(key: key);

  @override
  State<ShoppingPageChidlrensMobile> createState() =>
      _ShoppingPageChidlrensMobileState();
}

class _ShoppingPageChidlrensMobileState
    extends State<ShoppingPageChidlrensMobile> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body: Padding(
          ...
          child: ItemsGrid(itemListChildren,
