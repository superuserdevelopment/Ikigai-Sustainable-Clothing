...
class ShoppingPageMensMobile extends StatefulWidget {
  const ShoppingPageMensMobile({Key? key}) : super(key: key);

  @override
  State<ShoppingPageMensMobile> createState() => _ShoppingPageMensMobileState();
}

class _ShoppingPageMensMobileState extends State<ShoppingPageMensMobile> {
