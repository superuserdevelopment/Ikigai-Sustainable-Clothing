...
class ShoppingPageChildren extends StatefulWidget {
  const ShoppingPageChildren({Key? key}) : super(key: key);

  @override
  State<ShoppingPageChildren> createState() => _ShoppingPageStateChildren();
}

class _ShoppingPageStateChildren extends State<ShoppingPageChildren> {
  final List _isHovering = [false, false, false, false, false, false];
  List _categoryCheck = [false, false, true];
