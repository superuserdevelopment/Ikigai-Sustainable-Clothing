...
class ShoppingPageWomens extends StatefulWidget {
  const ShoppingPageWomens({Key? key}) : super(key: key);

  @override
  State<ShoppingPageWomens> createState() => _ShoppingPageStateWomens();
}

class _ShoppingPageStateWomens extends State<ShoppingPageWomens> {
  final List _isHovering = [false, false, false, false, false, false];
  List _categoryCheck = [false, true, false];
